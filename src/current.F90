...
!
  ...
  real,dimension(:,:), allocatable :: nszigmc,nszigm2,nszigm11,nszigm22,nsrhs
...
! Init:
!
  allocate(nszigmc(nmlonp1,nmlat))
  allocate(nszigm2(nmlonp1,nmlat))
  allocate(nszigm11(nmlonp1,nmlat))
  allocate(nszigm22(nmlonp1,nmlat))
  allocate(nsrhs(nmlonp1,nmlat))

  allocate(array(0:nmlon0+1,nmlat))
...
! External:
  real,external :: sddot ! in util.F
!
  allocate(tout(nmlonp1,nmlat,nmlevp1))
...
!
  ...
  real,dimension(:,:), allocatable :: dkqphi_glb,kqphi_glb
!
...
!   be3_mag,   'mlon',mlon0,mlon1,'mlat',mlat0,mlat1,0)
  ...
  allocate(dkqphi_glb(nmlonp1,nmlat))
  allocate(kqphi_glb(nmlonp1,nmlat))
...
!
  ...
  deallocate(dkqphi_glb)
  deallocate(kqphi_glb)
